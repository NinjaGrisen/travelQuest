 ...
 */
      ...
      function citySearch(searchForm, cities) {
        ...
        function showMatchingCitites(query) {
          cities.forEach(function(el) {
            var cityName = el.textContent.toLowerCase();
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var _timers = __webpack_require__(39);
      ...
      function ajaxHeart(e) {
        ...
        _axios2.default
          .post(this.action)
          .then(function(res) {
            var isHearted = _this.heart.classList.toggle(
              "heart__button--hearted"
            );
            (0, _bling.$)(".heart-count").textContent =
              res.data.bookmarked.length;
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      exports.toggle = function() {
        ...
        toggleCompleted.on("click", function(e) {
          ...
          var completedWrapperId = Array.prototype.slice.call(
            (0, _bling.$$)(".completed-list__wrapper")
          );
          var completedWrapperIndex = completedWrapperId.indexOf(
            completedWrapper
          );

          for (
            var i = 0;
            i < (0, _bling.$$)(".completed-list__wrapper").length;
            i++
          ) {
            if (i != completedWrapperIndex) {
              (0, _bling.$$)(".completed-list__wrapper")[i].classList.toggle(
                "completed-list__wrapper--hidden"
              );
            }
          }

          completedWrapper.classList.toggle(
            "completed-list__wrapper--expanded"
          );
        });
      };
            ...
            .then(function(res) {
              if (res.data.length) {
                searchResult.innerHTML = _dompurify2.default.sanitize(
                  searchCityResultsHTML(res.data)
                );
 ...
 */
     ...
     * DOMPurify. */
        ...
        var _parseConfig = function _parseConfig(cfg) {
          ...
          FORBID_TAGS =
            "FORBID_TAGS" in cfg ? _addToSet({}, cfg.FORBID_TAGS) : {};
          FORBID_ATTR =
            "FORBID_ATTR" in cfg ? _addToSet({}, cfg.FORBID_ATTR) : {};
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      /* WEBPACK VAR INJECTION */ (function(global, process) {
        ...
        /* WEBPACK VAR INJECTION */
      }.call(exports, __webpack_require__(40), __webpack_require__(3)));
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var _heart = __webpack_require__(14);
      ...
      var _mobileToggle = __webpack_require__(16);
      ...
      var _toggleCompletedQuest = __webpack_require__(17);

      var _toggleCompletedQuest2 = _interopRequireDefault(
        _toggleCompletedQuest
      );
      ...
      (0, _mobileToggle2.default)(
        (0, _bling.$)(".menu-btn"),
        (0, _bling.$)(".menu-sidebar"),
        (0, _bling.$)(".menu-btn__icon")
      );

      if (
        (0, _bling.$)(".single__description-toggle") &&
        (0, _bling.$)(".single__description")
      ) {
        (0, _descriptionToggle2.default)(
          (0, _bling.$)(".single__description-toggle"),
          (0, _bling.$)(".single__description")
        );
      }
      ...
      if ((0, _bling.$)("#complete-quest")) {
        (0, _completedQuest2.default)(
          (0, _bling.$)("#complete-quest"),
          (0, _bling.$)("#completed-quest-form"),
          (0, _bling.$)(".completed-quest__close")
        );
      }
      if ((0, _bling.$)("#searchForm")) {
        (0, _citySearch2.default)(
          (0, _bling.$)("#searchForm"),
          (0, _bling.$$)(".city-search")
        );
      }
